...
\draw[->] (-0.15,0) -- (-0.15,3.0) node[left,font=\scriptsize]{$p_i$};
\draw[->] (-0.15,0) -- (3.95,0);
\node[font=\scriptsize] at (1.85,-0.45) {query templates};
\node[font=\scriptsize, text=black!60] at (1.85,-0.95) {a few dominate (Zipf-skewed)};
...
\node[font=\scriptsize, text=black!60] at (6.55,0.2) {no queries run yet};

% arrow to budget bars
\draw[->,thick] (8.45,1.5) -- node[above,font=\scriptsize]{predicts} (9.85,1.5);
...
\draw[->] (9.85,0) -- (13.05,0);
\node[font=\scriptsize, align=center] at (10.35,-0.55) {Naive\\$k\varepsilon_q$};
\node[font=\scriptsize, align=center] at (11.4,-0.7) {Workload-\\aware\\$\varepsilon_q\mathbb{E}[u_k]$};
...
\draw[decorate, decoration={brace,amplitude=5pt}, thick] (11.95,\nh) -- (11.95,\wh)
  node[midway, right=6pt, align=left, font=\scriptsize]{savings\\$S=1-\dfrac{\mathbb{E}[u_k]}{k}$};

% ===== bottom spectrum strip =====
\node[font=\scriptsize\itshape, align=center] at (6.0,-1.8)
